(function (global, factory) {
	...
	function Y(t){let e,s=`algolia-client-js-${t.key}`;function r(){return e===void 0&&(e=t.localStorage||window.localStorage),e}function a(){return JSON.parse(r().getItem(s)||"{}")}function c(n){r().setItem(s,JSON.stringify(n));}function m(){return new Promise(n=>setTimeout(n,0))}function i(){let n=t.timeToLive?t.timeToLive*1e3:null,o=a(),l=new Date().getTime(),p=false;return {namespace:Object.fromEntries(Object.entries(o).filter(([,f])=>!f||f.timestamp===void 0||n&&f.timestamp+n<l?(p=true,false):true)),changed:p}}return {get(n,o,l={miss:()=>Promise.resolve()}){return m().then(()=>{let{namespace:p,changed:g}=i(),f=p[JSON.stringify(n)];return g&&c(p),f?f.value:o().then(T=>l.miss(T).then(()=>T))})},set(n,o){return m().then(()=>{let l=a();return l[JSON.stringify(n)]={timestamp:new Date().getTime(),value:o},r().setItem(s,JSON.stringify(l)),o})},delete(n){return m().then(()=>{let o=a();delete o[JSON.stringify(n)],r().setItem(s,JSON.stringify(o));})},clear(){return Promise.resolve().then(()=>{r().removeItem(s);})}}}function ce(){return {get(t,e,s={miss:()=>Promise.resolve()}){return e().then(a=>Promise.all([a,s.miss(a)])).then(([a])=>a)},set(t,e){return Promise.resolve(e)},delete(t){return Promise.resolve()},clear(){return Promise.resolve()}}}function A(t){let e=[...t.caches],s=e.shift();return s===void 0?ce():{get(r,a,c={miss:()=>Promise.resolve()}){return s.get(r,a,c).catch(()=>A({caches:e}).get(r,a,c))},set(r,a){return s.set(r,a).catch(()=>A({caches:e}).set(r,a))},delete(r){return s.delete(r).catch(()=>A({caches:e}).delete(r))},clear(){return s.clear().catch(()=>A({caches:e}).clear())}}}function D(t={serializable:true}){let e={};return {get(s,r,a={miss:()=>Promise.resolve()}){let c=JSON.stringify(s);if(c in e)return Promise.resolve(t.serializable?JSON.parse(e[c]):e[c]);let m=r();return m.then(i=>a.miss(i)).then(()=>m)},set(s,r){return e[JSON.stringify(s)]=t.serializable?JSON.stringify(r):r,Promise.resolve(r)},delete(s){return delete e[JSON.stringify(s)],Promise.resolve()},clear(){return e={},Promise.resolve()}}}function le(t){let e={value:`Algolia for JavaScript (${t})`,add(s){let r=`; ${s.segment}${s.version!==void 0?` (${s.version})`:""}`;return e.value.indexOf(r)===-1&&(e.value=`${e.value}${r}`),e}};return e}function Z(t,e,s="WithinHeaders"){let r={"x-algolia-api-key":e,"x-algolia-application-id":t};return {headers(){return s==="WithinHeaders"?r:{}},queryParameters(){return s==="WithinQueryParameters"?r:{}}}}function ee({algoliaAgents:t,client:e,version:s}){let r=le(s).add({segment:e,version:s});return t.forEach(a=>r.add(a)),r}function te(){return {debug(t,e){return Promise.resolve()},info(t,e){return Promise.resolve()},error(t,e){return Promise.resolve()}}}var ue=10*1024*1024;async function*de(t){let e=t.getReader();try{for(;;){let{done:s,value:r}=await e.read();if(s)return;yield r;}}finally{e.releaseLock();}}function me(t){return Symbol.asyncIterator in t?t:de(t)}async function*pe(t){let e=new TextDecoder("utf-8"),s=[],r=0,a=false,c=true;for await(let i of me(t)){let n=e.decode(i,{stream:true}),o=0;for(a&&(a=false,n.length>0&&n[0]===`
