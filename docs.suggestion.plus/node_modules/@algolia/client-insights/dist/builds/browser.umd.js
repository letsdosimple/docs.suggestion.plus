(function (global, factory) {
	...
	function Y(t){let e,n=`algolia-client-js-${t.key}`;function r(){return e===void 0&&(e=t.localStorage||window.localStorage),e}function o(){return JSON.parse(r().getItem(n)||"{}")}function c(s){r().setItem(n,JSON.stringify(s));}function m(){return new Promise(s=>setTimeout(s,0))}function i(){let s=t.timeToLive?t.timeToLive*1e3:null,a=o(),d=new Date().getTime(),h=false;return {namespace:Object.fromEntries(Object.entries(a).filter(([,p])=>!p||p.timestamp===void 0||s&&p.timestamp+s<d?(h=true,false):true)),changed:h}}return {get(s,a,d={miss:()=>Promise.resolve()}){return m().then(()=>{let{namespace:h,changed:g}=i(),p=h[JSON.stringify(s)];return g&&c(h),p?p.value:a().then(v=>d.miss(v).then(()=>v))})},set(s,a){return m().then(()=>{let d=o();return d[JSON.stringify(s)]={timestamp:new Date().getTime(),value:a},r().setItem(n,JSON.stringify(d)),a})},delete(s){return m().then(()=>{let a=o();delete a[JSON.stringify(s)],r().setItem(n,JSON.stringify(a));})},clear(){return Promise.resolve().then(()=>{r().removeItem(n);})}}}function ce(){return {get(t,e,n={miss:()=>Promise.resolve()}){return e().then(o=>Promise.all([o,n.miss(o)])).then(([o])=>o)},set(t,e){return Promise.resolve(e)},delete(t){return Promise.resolve()},clear(){return Promise.resolve()}}}function A(t){let e=[...t.caches],n=e.shift();return n===void 0?ce():{get(r,o,c={miss:()=>Promise.resolve()}){return n.get(r,o,c).catch(()=>A({caches:e}).get(r,o,c))},set(r,o){return n.set(r,o).catch(()=>A({caches:e}).set(r,o))},delete(r){return n.delete(r).catch(()=>A({caches:e}).delete(r))},clear(){return n.clear().catch(()=>A({caches:e}).clear())}}}function D(t={serializable:true}){let e={};return {get(n,r,o={miss:()=>Promise.resolve()}){let c=JSON.stringify(n);if(c in e)return Promise.resolve(t.serializable?JSON.parse(e[c]):e[c]);let m=r();return m.then(i=>o.miss(i)).then(()=>m)},set(n,r){return e[JSON.stringify(n)]=t.serializable?JSON.stringify(r):r,Promise.resolve(r)},delete(n){return delete e[JSON.stringify(n)],Promise.resolve()},clear(){return e={},Promise.resolve()}}}function ue(t){let e={value:`Algolia for JavaScript (${t})`,add(n){let r=`; ${n.segment}${n.version!==void 0?` (${n.version})`:""}`;return e.value.indexOf(r)===-1&&(e.value=`${e.value}${r}`),e}};return e}function Z(t,e,n="WithinHeaders"){let r={"x-algolia-api-key":e,"x-algolia-application-id":t};return {headers(){return n==="WithinHeaders"?r:{}},queryParameters(){return n==="WithinQueryParameters"?r:{}}}}function ee({algoliaAgents:t,client:e,version:n}){let r=ue(n).add({segment:e,version:n});return t.forEach(o=>r.add(o)),r}function te(){return {debug(t,e){return Promise.resolve()},info(t,e){return Promise.resolve()},error(t,e){return Promise.resolve()}}}var le=10*1024*1024;async function*de(t){let e=t.getReader();try{for(;;){let{done:n,value:r}=await e.read();if(n)return;yield r;}}finally{e.releaseLock();}}function me(t){return Symbol.asyncIterator in t?t:de(t)}async function*fe(t){let e=new TextDecoder("utf-8"),n=[],r=0,o=false,c=true;for await(let i of me(t)){let s=e.decode(i,{stream:true}),a=0;for(o&&(o=false,s.length>0&&s[0]===`
